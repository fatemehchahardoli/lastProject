...
import {
   ...
   useGetCountryQuery,
   useCreateGuestsMutation,
   useGetRoomsQuery,
} from "../redux/services/HotelApi";
...
const Checkout = () => {
   ...
   const getDeadTime = () => {
      ...
      const minutes = Math.floor((total1 / 1000 / 60) % 60);
   ...
   Countries?.map((country) => {
      const name = {
         ...
         customAbbreviation: country.flags.svg,
      };
   ...
   useEffect(() => {
      if (dataCookies != null) {
         if (Expiration_Minutes == true && dataCookies.length >= 1) {
            ...
            const total2 = Date.parse(time) - Date.parse(new Date());
            setTimeout(() => {
               cookies.remove("Expiration_Minutes");
               setShowTimer(false);
                        ...
                        <>
                           ...
                           <Formik
                              ...
                              validate={(values) => {
                                 ...
                                 const regPhonenumber = new RegExp(
                                    /^(00)\d{10,15}$/,
                                    "g"
                                 );
                                 ...
                                 if (
                                    !regEmail.test(values.emailAddress.trim())
                                 ) {
                                    errors.emailAddress =
                           ...
                           >
                              <Form className="information">
                                 ...
                                 <div className="policies">
                                    ...
                                    <p>
                                       50% deposit within 72h for stays between
                                       22/12 and 06/01 or stays equal or more
                                       than 250 000 MAD or for Prestige Suite,
                                       Exceptional Suites and Riad. Otherwise
                                       reservation will be automatically
                                       cancelled. 100% charge for no-show.{" "}
                                    </p>
                                    <h4>Cancel Policy</h4>
                                    <p>
                                       Free cancellation up to 7 days prior
                                       arrival, between 7 days and 24 hrs prior
                                       arrival 50% of the reservation amount
                                       will be due, beyond that 100% of the full
                                       stay amount will be due. In case of early
                                       check-out or no show, the full stay
                                       amount will be due.{" "}
                                    </p>
                                    <ul>
                                       <li>
                                          If you cancel your reservation from
                                          June 30, 2024 (local hotel time), you
                                          will be charged 100% of your total
                                          stay.
                                       </li>
                                    </ul>
                                 </div>
                                 <div className="Acknowledgement">
                                    ...
                                    <p>
                                       By completing this booking, I agree with
                                 ...
                                 <div className="btn_submit">
                                    ...
                                    >
                                       {value.length == 0 ? (
                                          <span>Please choice a date</span>
                                       ) : (
                                          <span>Book</span>
                                       )}
                                    </button>
                           ...
                           <div className="formPay">
                              ...
                              <Form className="Payment">
                                 <div>
                                    <div>
                                       <img
                                          src="https://be.synxis.com/public/images/Visa.png"
                                          alt=""
                                       />
                                       <img
                                          src="https://be.synxis.com/public/images/DinersClub.png"
                                          alt=""
                                       />
                                       <img
                                          src="https://be.synxis.com/public/images/Amex.png"
                                          alt=""
                                       />
                                       <img
                                          src="https://be.synxis.com/public/images/DinersClub.png"
                                       ...
                                       />
                                       <img
                                          src="https://be.synxis.com/public/images/JCB.png"
                                          alt=""
                                       />
                                       <img
                                          src="https://be.synxis.com/public/images/EuroCard.png"
                                          alt=""
                                       />
                                       <img
                                          src="https://be.synxis.com/public/images/ChinaUnionPay.png"
                                          alt=""
                                       />
                                    </div>
                                    ...
                                    <div>
                                       <div className="inpute_container_creditCard">
                                          ...
                                          />
                                          <div className="cut cut_Expiration">
                                             {" "}
                                          </div>
                                          <label
                                             htmlFor="name"
